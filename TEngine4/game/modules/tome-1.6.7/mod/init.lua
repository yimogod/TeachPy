...
load_tips = {
	...
	{image="/data/gfx/loadtiles/alchemist_golem.png", text=[[Alchemists can transmute gems to create fiery explosions, and are known to travel with a sturdy golem for extra protection.]]},
	...
	{image="/data/gfx/shockbolt/npc/humanoid_human_celia.png", img_y_off=-20, text=[[Who knows what dark thoughts drive people to necromancy? Its art is as old as magic itself, and its creations have plagued all the races since the earliest memories.]]},
	...
	{image="/data/gfx/shockbolt/npc/humanoid_dwarf_dwarven_earthwarden.png", text=[[Dwarves are naturally a inquisitive people, but do not enjoy such inquisition turned on them. Most live secretive lives in their closed-off city, the Iron Throne.]]},
	...
	{image="/data/gfx/shockbolt/terrain/woman_naked_altar.png", text=[[Rumours tell of a shadowy cult kidnapping women and performing strange rites. Their intentions are unknown, and they have so far evaded capture.]]},
	...
	{image="/data/gfx/shockbolt/npc/humanoid_elf_elven_archer.png", text=[[Archers are fast and deadly, and with pinning shots can render their foes helpless as they swiftly dispatch them.]]},
