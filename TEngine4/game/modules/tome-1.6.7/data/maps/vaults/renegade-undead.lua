...
defineTile('C', "BONEFLOOR", {random_filter={add_levels=12, tome_mod="uvault"}}, {random_filter={add_levels=16, name = "orc blood mage", random_boss={name_scheme="Inquisitor #rng#", nb_classes=0, loot_quality="store", loot_quantity=1, no_loot_randart=true, loot_unique=true, ai_move="move_complex", rank=3.5, force_classes={Corruptor=true}}}} )
