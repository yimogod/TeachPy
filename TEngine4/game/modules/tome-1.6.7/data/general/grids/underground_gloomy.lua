...
for i = 1, 30 do
	newEntity(class:makeNewTrees({base="UNDERGROUND_HARDTREE", define_as = "UNDERGROUND_HARDTREE"..i, image = "terrain/mushrooms/gloomy_underground_floor.png"}, treesdef, nil, "terrain/mushrooms/"))
end
