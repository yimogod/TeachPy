...
load("/data/general/npcs/yaech.lua", function(e) if e.name then e.inc_damage.all = -50 end end)
load("/data/general/npcs/aquatic_critter.lua", function(e) if e.name and e.name == "electric eel" then e.inc_damage.all = -35 end end, rarity(2))
...
newEntity{ base = "BASE_NPC_NAGA", define_as = "NAGA_TIDEWARDEN",
	...
	rarity = 1,
	max_life = resolvers.rngavg(100,120), life_rating = 10,
	resolvers.equip{
...
newEntity{ base="BASE_NPC_NAGA", define_as = "NASHVA",
	...
	max_stamina = 85,
	stats = { str=15, dex=10, cun=8, mag=10, con=20 },
	rank = 4,
	tier1 = true,
	size_category = 4,
	infravision = 10,
